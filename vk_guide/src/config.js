...
export const CATEGORIES = [
    ...
    },
    {
        ...
        category: 'vkpay',
        button_text: 'VK Pay',
        description: <span>VK Pay — это онлайн-сервис для оплаты товаров и услуг. Храните все банковские карты под рукой, получайте персональные скидки и спецпредложения, оплачивайте ежедневные услуги и переводите деньги друзьям в один клик.
